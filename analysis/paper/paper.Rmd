...
pca_data <- pca_data %>% 
  dplyr::select(SITE, Type, Dmn_R_M, Elevation = areaDEM_cut, Slope = areaSLOPE_cut, Aspect = areaASPECT_cut,
                Distance = areaDIST_cut2, Latitude = coords.x2)
...
plot_grid(open_air_elevation, open_air_slope, aspect_plot, open_air_distance, labels = c("A", "B", "C", "D"), nrow = 2, ncol = 2)
...
pca_data_active2 <- dplyr::select(pca_data, Elevation,
                                 Aspect, Slope, Distance, Latitude)
